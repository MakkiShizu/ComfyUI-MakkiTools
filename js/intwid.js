...
// 通用节点扩展函数
function extendNodeForDynamicInputs(nodeType, inputName = "int") {
  // 增强序列化功能
  ...
  nodeType.prototype.onConfigure = function (data) {
    ...
    manageDynamicInputs(this, -1, false, inputName, "INT");
  ...
  nodeType.prototype.onConnectionsChange = function (
    ...
    // 始终使用"INT"类型
    manageDynamicInputs(this, index, connected, inputName, "INT");
